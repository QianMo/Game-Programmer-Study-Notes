...
- [三、使用基于GPU几何体裁剪图的地形渲染（Terrain Rendering Using GPU-Based](#三使用基于gpu几何体裁剪图的地形渲染terrain-rendering-using-gpu-based)
    - [【章节概览】](#章节概览)
    - [【核心要点】](#核心要点)
    - [【关键词】](#关键词)
...
- [七、让硬件遮挡查询发挥作用（Hardware Occlusion Queries Made Useful）](#七让硬件遮挡查询发挥作用hardware-occlusion-queries-made-useful)
    ...
    - [【核心要点】](#核心要点-4)
    - [【关键词】](#关键词-4)
- [八、带位移映射的细分表面自适应镶嵌（Adaptive Tessellation of Subdivision](#八带位移映射的细分表面自适应镶嵌adaptive-tessellation-of-subdivision)
    - [【章节概览】](#章节概览-5)
    - [【核心要点】](#核心要点-5)
    - [【关键词】](#关键词-5)
...
# 三、使用基于GPU几何体裁剪图的地形渲染（Terrain Rendering Using GPU-Based
Geometry Clipmaps）
...
# 八、带位移映射的细分表面自适应镶嵌（Adaptive Tessellation of Subdivision
