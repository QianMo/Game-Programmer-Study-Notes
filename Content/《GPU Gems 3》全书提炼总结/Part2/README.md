...
本文是【GPU精粹与Shader编程】系列的第七篇文章。文章盘点、提炼和总结了《GPU Gems 3》中游戏开发、图形学与渲染相关总计28章的核心内容。
...
作为《GPU精粹3》的开篇章节，这章给出了一个使用GPU在交互速率下生成令人信服的、没有限制的复杂程序化三维地形的方法。同样也展示了如何对地形进行纹理映射和着色、如何为地形创建LOD的方案。
...
通过【GPU精粹与Shader编程】系列的这前7篇文章，我们已经将这三本书中的重点内容，全都过了一遍。希望各位读者能有所收获。
