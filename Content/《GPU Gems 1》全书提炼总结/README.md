...
- [【GPU精粹与Shader编程】《GPU Gems 1》全书核心内容提炼总结](#gpu精粹与shader编程gpu-gems-1全书核心内容提炼总结)
- [上篇 · 主核心内容提炼总结](#上篇-·-主核心内容提炼总结)
- [一、 用物理模型进行高效的水模拟（Effective Water Simulation from Physical Models）](#一-用物理模型进行高效的水模拟effective-water-simulation-from-physical-models)
    - [【内容概览】](#内容概览)
    - [【核心内容提炼】](#核心内容提炼)
        - [1.1 背景与范围](#11-背景与范围)
        - [1.2 水体渲染的思路](#12-水体渲染的思路)
            - [1.2.1 波的选择](#121-波的选择)
            - [1.2.2 法线与切线](#122-法线与切线)
        - [1.3 波的几何特征](#13-波的几何特征)
            - [1.3.2 Gerstner波](#132-gerstner波)
            - [1.3.3 波长等参数的选择](#133-波长等参数的选择)
        - [1.4 波的纹理特征](#14-波的纹理特征)
        - [1.5 关于深度](#15-关于深度)
    - [【核心要点总结】](#核心要点总结)
    - [【关键词提炼】](#关键词提炼)
- [二、Dawn Demo中的皮肤渲染（Skin in the Dawn Demo）](#二dawn-demo中的皮肤渲染skin-in-the-dawn-demo)
    - [十年技术变迁： NVIDIA Dawn Demo](#十年技术变迁-nvidia-dawn-demo)
    - [【章节概览】](#章节概览)
    - [【核心内容提炼】](#核心内容提炼-1)
        - [2.1 关于皮肤着色](#21-关于皮肤着色)
        - [2.2 皮肤如何对光进行响应](#22-皮肤如何对光进行响应)
        - [2.3 场景的照明](#23-场景的照明)
        - [2.4 实现](#24-实现)
    - [【核心要点总结】](#核心要点总结-1)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表)
    - [【关键词提炼】](#关键词提炼-1)
- [三、无尽波动的草地叶片的渲染（Rendering Countless Blades of Waving Grass）](#三无尽波动的草地叶片的渲染rendering-countless-blades-of-waving-grass)
    - [【章节概览】](#章节概览-1)
    - [【核心内容提炼】](#核心内容提炼-2)
        - [3.1 概述](#31-概述)
        - [3.2 草的纹理](#32-草的纹理)
        ...
        - [3.4 草地动画](#34-草地动画)
    - [【核心要点总结】](#核心要点总结-2)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-1)
    - [【关键词提炼】](#关键词提炼-2)
- [四、次表面散射的实时近似（Real-Time Approximations to Subsurface Scattering）](#四次表面散射的实时近似real-time-approximations-to-subsurface-scattering)
    - [【章节概览】](#章节概览-2)
    - [【核心内容提炼】](#核心内容提炼-3)
        - [4.1 次表面散射的视觉特性（The Visual Effects of Subsurface Scattering）](#41-次表面散射的视觉特性the-visual-effects-of-subsurface-scattering)
        - [4.2 简单的散射近似（Simple Scattering Approximations）](#42-简单的散射近似simple-scattering-approximations)
        - [4.3 使用深度贴图模拟吸收（Simulating Absorption Using Depth Maps）](#43-使用深度贴图模拟吸收simulating-absorption-using-depth-maps)
        - [4.4 纹理空间的漫反射（Texture-Space Diffusion）](#44-纹理空间的漫反射texture-space-diffusion)
    - [【核心要点总结】](#核心要点总结-3)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-2)
    - [【关键词提炼】](#关键词提炼-3)
- [五、环境光遮蔽（Ambient Occlusion）](#五环境光遮蔽ambient-occlusion)
    - [【章节概览】](#章节概览-3)
    - [【核心内容提炼】](#核心内容提炼-4)
        - [5.3 使用环境光遮蔽贴图进行渲染（Rendering with Ambient Occlusion Maps）](#53-使用环境光遮蔽贴图进行渲染rendering-with-ambient-occlusion-maps)
    - [【核心要点总结】](#核心要点总结-4)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-3)
    - [【关键词提炼】](#关键词提炼-4)
- [六、实时辉光（Real-Time Glow）](#六实时辉光real-time-glow)
    - [【章节概览】](#章节概览-4)
    - [【核心内容提炼】](#核心内容提炼-5)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-4)
    - [【关键词提炼】](#关键词提炼-5)
- [下篇 · 次核心内容提炼总结](#下篇-·-次核心内容提炼总结)
- [七、水焦散的渲染 （Rendering Water Caustics）](#七水焦散的渲染-rendering-water-caustics)
    - [【章节概览】](#章节概览-5)
    - [【核心要点】](#核心要点)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-5)
        - [【关键词提炼】](#关键词提炼-6)
- [八、 Dawn Demo中的动画（Animation in the "Dawn" Demo）](#八-dawn-demo中的动画animation-in-the-dawn-demo)
    - [【章节概览】](#章节概览-6)
    - [【核心要点】](#核心要点-1)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-6)
    - [【关键词提炼】](#关键词提炼-7)
- [九、 改良的Perlin噪声实现（Implementing Improved Perlin Noise）](#九-改良的perlin噪声实现implementing-improved-perlin-noise)
    - [【章节概览】](#章节概览-7)
    - [【核心要点】](#核心要点-2)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-7)
    - [【关键词提炼】](#关键词提炼-8)
- [十、Vulcan Demo中的火焰渲染（Fire in the "Vulcan" Demo）](#十vulcan-demo中的火焰渲染fire-in-the-vulcan-demo)
    - [【章节概览】](#章节概览-8)
    - [【核心要点】](#核心要点-3)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-8)
    - [【关键词提炼】](#关键词提炼-9)
- [十一、衍射的模拟（Simulating Diffraction）](#十一衍射的模拟simulating-diffraction)
    - [【章节概览】](#章节概览-9)
    - [【核心要点】](#核心要点-4)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-9)
    - [【关键词提炼】](#关键词提炼-10)
- [十二、高效的阴影体渲染（Efficient Shadow Volume Rendering）](#十二高效的阴影体渲染efficient-shadow-volume-rendering)
    - [【章节概览】](#章节概览-10)
    - [【核心要点】](#核心要点-5)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-10)
    - [【关键词提炼】](#关键词提炼-11)
- [十三、电影级光照（Cinematic Lighting）](#十三电影级光照cinematic-lighting)
    - [【章节概览】](#章节概览-11)
    - [【核心要点】](#核心要点-6)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-11)
    - [【关键词提炼】](#关键词提炼-12)
- [十四、阴影贴图抗锯齿（Shadow Map Antialiasing）](#十四阴影贴图抗锯齿shadow-map-antialiasing)
    - [【章节概览】](#章节概览-12)
    - [【核心要点】](#核心要点-7)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-12)
    - [【关键词提炼】](#关键词提炼-13)
- [十五、全方位阴影贴图（Omnidirectional Shadow Mapping）](#十五全方位阴影贴图omnidirectional-shadow-mapping)
    - [【章节概览】](#章节概览-13)
    - [【核心要点】](#核心要点-8)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-13)
    - [【关键词提炼】](#关键词提炼-14)
- [十六、使用遮挡区间映射产生模糊的阴影（Generating Soft Shadows Using Occlusion Interval Maps）](#十六使用遮挡区间映射产生模糊的阴影generating-soft-shadows-using-occlusion-interval-maps)
    - [【章节概览】](#章节概览-14)
    - [【核心要点】](#核心要点-9)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-14)
    - [【关键词提炼】](#关键词提炼-15)
- [十七、透视阴影贴图（Perspective Shadow Maps: Care and Feeding）](#十七透视阴影贴图perspective-shadow-maps-care-and-feeding)
    - [【章节概览】](#章节概览-15)
    - [【核心要点】](#核心要点-10)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-15)
    - [【关键词提炼】](#关键词提炼-16)
- [十八、逐像素光照的可见性管理（Managing Visibility for Per-Pixel Lighting）](#十八逐像素光照的可见性管理managing-visibility-for-per-pixel-lighting)
    - [【章节概览】](#章节概览-16)
    - [【核心要点】](#核心要点-11)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-16)
    - [【关键词提炼】](#关键词提炼-17)
- [十九、空间BRDF（Spatial BRDFs）](#十九空间brdfspatial-brdfs)
    - [【章节概览】](#章节概览-17)
    - [【核心要点】](#核心要点-12)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-17)
    - [【关键词提炼】](#关键词提炼-18)
- [二十、基于图像的光照（Image-Based Lighting）](#二十基于图像的光照image-based-lighting)
        - [【章节概览】](#章节概览-18)
        - [【核心要点】](#核心要点-13)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-18)
    - [【关键词提炼】](#关键词提炼-19)
- [二十一、纹理爆炸（Texture Bombing）](#二十一纹理爆炸texture-bombing)
    - [【章节概览】](#章节概览-19)
    - [【核心要点】](#核心要点-14)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-19)
    - [【关键词提炼】](#关键词提炼-20)
- [二十二、颜色控制（Color Controls）](#二十二颜色控制color-controls)
    - [【章节概览】](#章节概览-20)
    - [【核心要点】](#核心要点-15)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-20)
    - [【关键词提炼】](#关键词提炼-21)
- [二十三、景深 （Depth of Field）](#二十三景深-depth-of-field)
    - [【章节概览】](#章节概览-21)
    - [【核心要点】](#核心要点-16)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-21)
    - [【关键词提炼】](#关键词提炼-22)
- [二十四、高品质的图像滤波（High-Quality Filtering）](#二十四高品质的图像滤波high-quality-filtering)
    - [【章节概览】](#章节概览-22)
    - [【核心要点】](#核心要点-17)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-22)
    - [【关键词提炼】](#关键词提炼-23)
- [二十五、用纹理贴图进行快速滤波宽度的计算（Fast Filter-Width Estimates with Texture Maps）](#二十五用纹理贴图进行快速滤波宽度的计算fast-filter-width-estimates-with-texture-maps)
    - [【章节概览】](#章节概览-23)
    - [【核心要点】](#核心要点-18)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-23)
    - [【关键词提炼】](#关键词提炼-24)
- [二十六、OpenEXR图像文件格式（The OpenEXR Image File Format）](#二十六openexr图像文件格式the-openexr-image-file-format)
    - [【章节概览】](#章节概览-24)
    - [【核心要点】](#核心要点-19)
    - [【本章配套源代码汇总表】](#本章配套源代码汇总表-24)
    - [【关键词提炼】](#关键词提炼-25)
- [Reference](#reference)
